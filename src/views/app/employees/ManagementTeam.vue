<template>
  <b-row>
    <b-colxx class="disable-text-selection" style="padding: 0">
      ...
      ></list-page-heading>
      <b-card :title="$t(`menu.management_team`)">
        <b-table
          hover
          :items="items"
          :fields="fields"
...
<script>
import ListPageHeading from "./ManagementHeading";
...
export default {
  ...
  data() {
    return {
      ...
      items: [
        { name: 'James Smith', phone: '+998900006996', role: 'admins' },
        { name: 'Robert Smith', phone: '+998900006996', role: 'admins' },
        { name: 'John Smith', phone: '+998900006996', role: 'admins' },
        { name: 'Michael Smith', phone: '+998900006996', role: 'admins' },
        { name: 'William Smith', phone: '+998900006996', role: 'admins' },
        { name: 'David Smith', phone: '+998900006996', role: 'admins' },
        { name: 'Richard Smith', phone: '+998900006996', role: 'admins' },
        { name: 'Joseph Smith', phone: '+998900006996', role: 'admins' },
        { name: 'Thomas Smith', phone: '+998900006996', role: 'admins' },
        { name: 'Charles Smith', phone: '+998900006996', role: 'admins' },
      ],
      selectedItems: []
    };
  },
